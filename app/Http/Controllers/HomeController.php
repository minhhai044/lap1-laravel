...
class HomeController extends Controller
{
    public function index()
    {
        ...
        DB::table('employees')
        ->join('departments','employees.department_id','=','departments.department_id')
        ->where('employees.salary','>',70000)->where('departments.department_name','Marketing')
        ->select('employees.first_name', 'employees.last_name', 'departments.department_name')
        ->get();
        // YC3
        DB::table('employees')
        ->join('departments','employees.department_id','=','departments.department_id')
        ->whereBetween('employees.salary',[50000,70000])
        ->select('employees.first_name', 'employees.last_name', 'departments.department_name')
        ->get();
        //YC4
        DB::table('employees')->join('departments','employees.department_id','=','departments.department_id')
